...
comment_form(
    array(
        'class_submit' => 'bg-accent-3 hover:bg-sky-700 text-white cursor-pointer rounded font-medium text-[0.925rem] py-2 px-4',
...
?>
    ...
    <div>
        ...
        <span class="block">
            <?php
$link = '<a href="#" class="text-sky-500" data-comment-login-button>' . _e('logged in', 'kiranime') . '</a>';
