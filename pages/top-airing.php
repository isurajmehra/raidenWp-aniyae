...
/**
 * Template Name: Top airing archive
 *
 * @package Kiranime
 */
...
$q = new Kiranime_Anime();
$posts = $q->featured(true, 'airing', $page);
?>
...
<section class="mb-17 grid grid-cols-12 px-5 mx-auto w-full gap-5">
    <section class="col-span-full <?php if ($sidebar_active) {echo 'lg:col-span-9';}?>">
        <h3 class="mb-4 text-2xl font-semibold leading-10 text-sky-400"><?php the_title()?></h3>
