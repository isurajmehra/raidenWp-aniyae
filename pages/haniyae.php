...
/**
 * Template Name: Hentai Haniyae pagina
 *
 * @package Kiranime
 */
...
<section class="mb-17 grid grid-cols-12 px-5 mx-auto w-full gap-5">
    <section class="col-span-full <?php if ($sidebar_active) {echo 'lg:col-span-9';}?>">
        <h3 class="text-2xl leading-10 font-semibold p-0 m-0 mt-2 mb-2" style="color: #ff0080;">
            <?=get_option('__show_latest_label', 'H-Aniyae')?>
        </h3>
        <div
            ...
            Kiranime_Utility::template('view-haniyae');
        else:
