...
class Kiranime_Utility
{
    ...
    public static function get_js_translation()
    {
        return [
            'app_js' => [
                'app:64' => __('- Show Less', 'kiranime'),
                'app:68' => __('+ Show More', 'kiranime'),
                'app:112' => __('Loading...', 'kiranime'),
                'app:137' => __('Log Me In', 'kiranime'),
                'app:161' => __('Password not match!', 'kiranime'),
                'app:181' => __('Something went wrong..', 'kiranime'),
                'app:184' => __('Register', 'kiranime'),
                'app:205' => __('Register successful!', 'kiranime'),
                'app:206' => __('Logging in..!', 'kiranime'),
                'app:209' => __('Reloading..', 'kiranime'),
                'app:441' => __('${1} - Episode ${2} Available NOW!', 'kiranime'),
                'app:563' => __('Anime added to watchlist.', 'kiranime'),
                'app:565' => __('Error adding anime to watchlist.', 'kiranime'),
                'app:591' => __('Setting has been saved.', 'kiranime'),
                'app:608' => __('Logout success, reloading!', 'kiranime'),
            ],
            'avatar_upload_js' => [
                'avatar_upload:83' => __('Uploading...', 'kiranime'),
                'avatar_upload:102' => __('Sorry, something is wrong.', 'kiranime'),
                'avatar_upload:112' => __('Avatar has been changed.', 'kiranime'),
            ],
            'mal_import_js' => [
                'mal_import:12' => __('Failed to connect to MyAnimeList.', 'kiranime'),
                'mal_import:13' => __('Please try again a few minutes.', 'kiranime'),
                'mal_import:71' => __('Importing...', 'kiranime'),
                'mal_import:84' => __('Importing...', 'kiranime'),
            ],
            'vote_js' => [
                'vote:31' => __('Failed to send your vote :(', 'kiranime'),
                'vote:51' => __('( ${1} Voted)', 'kiranime'),
                'vote:52' => __('Vote success! :D', 'kiranime'),
            ],
            'vue_js' => [
                'vue_js:w9' => __('All', 'kiranime'),
                'vue_js:w32' => __('No Anime Found.', 'kiranime'),
                'vue_js:p37' => __('Theater Mode', 'kiranime'),
                'vue_js:p118' => __('You\'re watching', 'kiranime'),
                'vue_js:p122' => __('Episode ${1}', 'kiranime'),
                'vue_js:p131' => __('If current player not working, select other server.', 'kiranime'),
                'vue_js:p157' => __('SUB', 'kiranime'),
                'vue_js:p191' => __('DUB', 'kiranime'),
                'vue_js:p218' => __('Estimated the next episode will come at', 'kiranime'),
                'vue_js:p384' => __('Anime has been removed.', 'kiranime'),
                'vue_js:wg181' => __('Anime has been removed.', 'kiranime'),
                'vue_js:wg183' => __('Anime has been moved.', 'kiranime'),
                'vue_js:wg187' => __('Error occured!', 'kiranime'),
            ],
            'user_locale' => [
    ...
    {
        $anime_meta = [
            __('spotlight', 'kiranime'),
            __('rate', 'kiranime'),
            __('native', 'kiranime'),
            __('synonyms', 'kiranime'),
            __('aired', 'kiranime'),
            __('premiered', 'kiranime'),
            __('duration', 'kiranime'),
            __('episodes', 'kiranime'),
            __('score', 'kiranime'),
            __('updated', 'kiranime'),
            __('Profile', 'kiranime'),
            __('Continue Watching', 'kiranime'),
            __('Genres', 'kiranime'),
            __('Watch List', 'kiranime'),
            __('Notification', 'kiranime'),
            __('MAL Import', 'kiranime'),
        ];
    }
