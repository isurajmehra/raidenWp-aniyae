<div class="w-full sm:mt-17 lg:mt-9 sm:mb-5  bg-sky-500 bg-opacity-0 flex items-center relative justify-center" style="max-width: 53rem;">
    ...
    <div class="swiper-navigation absolute bottom-5 right-5 z-10 hidden sm:block">
        <div class="mb-2 bg-primary rounded-sm shadow-sm p-2 nav-next hover:bg-sky-700" tabindex="0" role="button"
        ...
        <div class="bg-primary rounded-sm shadow-sm p-2 nav-prev hover:bg-sky-700" tabindex="0" role="button"
