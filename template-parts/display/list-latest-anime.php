<div class="w-full mb-4 flex items-center justify-between px-4 sm:px-0">
    <div class="mr-4">
        <h2 class="text-2xl leading-10 font-semibold p-0 m-0 text-sky-400">
            <?php $title = get_theme_mod('__show_latest_label');if ($title) {echo $title;} else {_e('Latest Update', 'kiranime');}?>
        </h2>
    </div>
    <div class="text-sm font-normal text-opacity-75">
        <a class="flex items-center gap-2" href="<?=Kiranime_Utility::page_url('pages/latest-update.php');?>">
