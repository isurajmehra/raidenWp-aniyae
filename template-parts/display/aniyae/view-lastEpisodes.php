    ...
    <a href="<?=Kiranime_Utility::page_url('pages/latest-update.php');?>" class="px-4 py-2 rounded-full w-max max-w-max items-center flex  bg-accent-3 font-medium text-sm my-5 mx-3" style="position: relative; left: 20vh;">
        Ver mas
