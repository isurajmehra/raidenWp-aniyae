...
<h3 class="mb-4 text-2xl font-semibold leading-10 text-sky-400">Horario, Capitulos subtitulados</h3>
<div class="heroarea">
    <div class="heromain">
    <?php $page = (get_query_var('paged')) ? get_query_var('paged') : 1; $query = new Kiranime_Query(['page' => $page, 'archive' => true]); $posts = $query->lunes();?>
    ...
    <?php $page2 = (get_query_var('paged')) ? get_query_var('paged') : 1;
        ...
        <?php $page6 = (get_query_var('paged')) ? get_query_var('paged') : 1;
          ...
          $posts6 = $query6->sabado(); ?>
        <div class="accordionItem close">
            <h1 class="accordionItemHeading">Sabado <div id="chevron-arrow"></div></h1>
            <div class="accordionItemContent">
