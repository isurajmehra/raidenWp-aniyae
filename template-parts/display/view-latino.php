<div class="w-full mb-4 flex items-center justify-between mt-10 px-4 sm:px-0">
    <div class="mr-4">
        <h2 class="text-2xl leading-10 font-semibold p-0 m-0 text-sky-400">
            <?php $title = get_theme_mod('__show_new_label');if ($title) {echo $title;} else {_e('Latino y solo latino!', 'kiranime');}?>
        </h2>
    </div>
    <div class="text-sm font-normal text-opacity-75">
        <a class="flex items-center gap-2" href="<?=Kiranime_Utility::page_url('pages/latino.php');?>">
            <?php _e('Ver mas', 'kiranime');?>
