<div
    ...
    <h3 class="mb-6 text-2xl font-medium text-center"><?php _e('Inicia sesión en tu cuenta', 'kiranime')?></h3>
    ...
    <div class="block">
        <button data-login-button class="w-full px-3 py-4 font-medium text-white bg-accent-3 rounded-lg">
            <?php _e('Iniciar', 'kiranime');?>
        </button>
    </div>
    <p data-login-error-info class="w-full mt-4 text-sm text-center text-rose-500"></p>
    <p class="w-full mt-4 text-sm text-center text-gray-400"><?php _e("No tienes una cuenta?", 'kiranime')?> <button
            data-to-register-button class="text-sky-500 underline"><?php _e('Crea una aqui.', 'kiranime')?></button></p>
